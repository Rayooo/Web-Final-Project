    ...
    <div class="container">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php"><i class="fa fa-leaf" aria-hidden="true"></i>学生展示平台</a>
            </div>

            <div class="collapse navbar-collapse" id="navbarCollapse1">
                <ul class="nav navbar-nav navbar-right">
                    <a type='button' class='btn btn-primary navbar-btn' href='index.php'>返回</a>
                </ul>
            </div>
        </div>
    </div>
    ...
    <form class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-12">
                ...
                <a class="btn btn-lg btn-default formButton" href="index.php">取消</a>
            </div>
        </div>
    </form>
</div>
...
<script>
    $("#submitButton").click(function () {
        if(registerData.isOkUserName && registerData.isOkPassword2 && registerData.isOkRealName){
            ...
            $.post("registerPost.php",{userName:registerData.userName,password:registerData.password,name:registerData.realName,isManager:isManager},function (data) {
                if(data == "success"){
                    swal({
                        title: "成功",
