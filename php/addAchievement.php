...
<script>
    $("#btn").click(function () {
        ...
        if(!achievementContent || !achievementTitle){
            ...
            $.post("addAchievementPost.php", {achievementContent:achievementContent,userId:userId,achievementTitle:achievementTitle}, function (data) {
                console.log(data);
                if(data == "success"){
                    swal({
                        title: "成功",
                        ...
                        window.location.href = "myAchievementList.php";
                    });
                }
                else{
                    swal("失败", "服务器异常", "error");
